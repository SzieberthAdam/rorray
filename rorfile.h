...
#define A_GAME_ERAI 1
#define A_GAME_ERAI_t uint8_t
#define A_GAME_TURN 2
#define A_GAME_TURN_t int16_t
#define A_GAME_PHSE 3
#define A_GAME_PHSE_t int16_t
#define A_GAME_SPHS 4
#define A_GAME_SPHS_t uint32_t
#define A_GAME_TEMP 5
#define A_GAME_TEMP_t unsigned char[6]
#define G_ERAR 2
#define A_ERAR_NAME 0
#define A_ERAR_NAME_t char[16]
#define A_ERAR_NSEN 1
#define A_ERAR_NSEN_t uint8_t
#define A_ERAR_TERC 2
#define A_ERAR_TERC_t uint8_t
#define G_FACT 3
...
#define G_SENA 8
#define A_SENA_ERAI 0
#define A_SENA_ERAI_t uint8_t
...
#define G_SMAN 9
#define A_SMAN_ERAI 0
#define A_SMAN_ERAI_t uint8_t
